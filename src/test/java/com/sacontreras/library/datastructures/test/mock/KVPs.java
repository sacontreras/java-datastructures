...
public class KVPs {
    ...
    static {
        try {
            ...
            KVPs.ary_kvp_ssn_name_expected_inorder[0] = new BoxedType<CKeyValuePair<String, String>>(new CKeyValuePair<String, String>("554975177", "Steven Contreras"));
            KVPs.ary_kvp_ssn_name_expected_inorder[1] = new BoxedType<CKeyValuePair<String, String>>(new CKeyValuePair<String, String>("554975176", "A Mistake!"));
