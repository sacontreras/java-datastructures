...
public class KVPs {
    ...
    static {
        try {
            ...
            KVPs.ary_kvp_ssn_name_expected_inorder[0] = new BoxedType<CKeyValuePair<String, String>>(new CKeyValuePair<String, String>("123456789", "Steven Contreras"));
            KVPs.ary_kvp_ssn_name_expected_inorder[1] = new BoxedType<CKeyValuePair<String, String>>(new CKeyValuePair<String, String>("012345678", "A Mistake!"));
